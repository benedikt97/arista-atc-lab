#!/bin/bash
hostnamectl hostname sdf-server2
BOND_NAME="bond0"
SLAVE1="eth1"
SLAVE2="eth2"
BOND_IP="192.168.12.6/24"
BOND_MODE="802.3ad" 
modprobe bonding
