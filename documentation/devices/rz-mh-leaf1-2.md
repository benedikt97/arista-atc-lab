...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_rz-spine1_Ethernet2 | - | 2001:db8:b4:6::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_rz-spine2_Ethernet2 | - | 2001:db8:b4:7::2/64 | default | 1500 | False | - | - | - | - |
...
interface Ethernet1
   ...
   mtu 1500
   no switchport
   ipv6 address 2001:db8:b4:6::2/64
!
interface Ethernet2
   ...
   mtu 1500
   no switchport
   ipv6 address 2001:db8:b4:7::2/64
```
...
| Loopback10 | DIAG_VRF_VRF4 | VRF4 | 10.255.10.4/32 |

##### IPv6

| Interface | Description | VRF | IPv6 Address |
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:a1:4::1/64 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2001:db8:a2:4::1/64 |
...
interface Loopback0
   ...
   no shutdown
   ipv6 address 2001:db8:a1:4::1/64
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ipv6 address 2001:db8:a2:4::1/64
!
...
!
interface Vxlan1
   description rz-mh-leaf1-2_VTEP
...
| 2001:db8:b4:6::1 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 2001:db8:b4:7::1 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65104
   ...
   neighbor 2001:db8:b4:6::1 peer group IPv4-UNDERLAY-PEERS
   neighbor 2001:db8:b4:6::1 remote-as 65101
   neighbor 2001:db8:b4:6::1 description rz-spine1_Ethernet2
   neighbor 2001:db8:b4:7::1 peer group IPv4-UNDERLAY-PEERS
   neighbor 2001:db8:b4:7::1 remote-as 65102
   neighbor 2001:db8:b4:7::1 description rz-spine2_Ethernet2
...
```eos
!
ip address virtual source-nat vrf VRF4 address 10.255.10.4
```
