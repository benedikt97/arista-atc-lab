...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.22.0.101/24 | 172.22.0.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_rz-sdf-leaf1-1_Ethernet1 | - | 10.255.201.8/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_rz-sdf-leaf1-2_Ethernet1 | - | 10.255.201.12/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_center-leaf2-1_Ethernet1 | - | 10.255.202.16/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_center-leaf2-2_Ethernet1 | - | 10.255.202.20/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_rz-sdf-leaf1-1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.201.8/31
!
interface Ethernet2
   description P2P_rz-sdf-leaf1-2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.201.12/31
!
interface Ethernet3
   description P2P_center-leaf2-1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_center-leaf2-2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
