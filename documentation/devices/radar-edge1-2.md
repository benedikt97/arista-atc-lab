...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_radar-edge1-1_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_radar-edge1-1_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
...
!
interface Ethernet3
   description MLAG_radar-edge1-1_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_radar-edge1-1_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet6
...
interface Port-Channel3
   description MLAG_radar-edge1-1_Port-Channel3
   no shutdown
...
!
interface Vxlan1
   description radar-edge1-2_VTEP
