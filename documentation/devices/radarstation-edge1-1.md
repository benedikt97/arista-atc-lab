...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.22.0.109/24 | 172.22.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| RADARSTATION-EDGE1 | Vlan4094 | 10.255.255.81 | Port-Channel3 |
...
!
mlag configuration
   domain-id RADARSTATION-EDGE1
   local-interface Vlan4094
   peer-address 10.255.255.81
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_radarstation-edge1-2_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_radarstation-edge1-2_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet5 | SERVER_radar-cam1_eth1 | access | 221 | - | - | - |
| Ethernet6 | SERVER_radar_eth1 | *access | *250 | *- | *- | 6 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_router_eth3 | - | 10.250.230.9/30 | default | 1500 | False | - | - |

##### IPv6

| Interface | Description | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_router_eth3 | - | - | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_router_eth3
   no shutdown
   mtu 1500
   no switchport
   ip address 10.250.230.9/30
   ipv6 enable
!
interface Ethernet3
   description MLAG_radarstation-edge1-2_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_radarstation-edge1-2_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description SERVER_radar-cam1_eth1
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_radarstation-edge1-2_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_radarstation-edge1-2_Port-Channel3
   no shutdown
...
interface Port-Channel6
   description SERVER_radar_Bond0
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.255.3.9/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.255.4.9/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.255.3.9/32
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ip address 10.255.4.9/32
```
...
| Vlan3010 |  VRF-RDR  |  10.255.255.112/31  |  -  |  -  |  -  |  -  |
| Vlan3011 |  VRF-CAM  |  10.255.255.112/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.255.112/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.255.80/31  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description radarstation-edge1-1_VTEP
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 220 | 10.255.3.9:10220 | 10220:10220<br>remote 10220:10220 | - | - | learned |
| 221 | 10.255.3.9:10221 | 10221:10221<br>remote 10221:10221 | - | - | learned |
| 250 | 10.255.3.9:10250 | 10250:10250<br>remote 10250:10250 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF-CAM | 10.255.3.9:12 | connected | - |
| VRF-RDR | 10.255.3.9:11 | connected | - |
...
router bgp 65109
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description radarstation-edge1-2
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.250.230.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.250.230.10 remote-as 65202
   neighbor 10.250.230.10 description router
   neighbor 10.255.1.3 peer group EVPN-OVERLAY-CORE
   neighbor 10.255.1.3 remote-as 65103
   neighbor 10.255.1.3 description rz-sdf-leaf1-1_Loopback0
   neighbor 10.255.255.113 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.255.113 description radarstation-edge1-2_Vlan4093
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 220
      rd 10.255.3.9:10220
      rd evpn domain remote 10.255.3.9:10220
   ...
   vlan 221
      rd 10.255.3.9:10221
      rd evpn domain remote 10.255.3.9:10221
   ...
   vlan 250
      rd 10.255.3.9:10250
      rd evpn domain remote 10.255.3.9:10250
   ...
   vrf VRF-CAM
      ...
      update wait-install
      neighbor 10.255.255.113 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.255.113 description radarstation-edge1-2_Vlan3011
   ...
   vrf VRF-RDR
      ...
      update wait-install
      neighbor 10.255.255.113 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.255.113 description radarstation-edge1-2_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
