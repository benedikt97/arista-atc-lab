...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.22.0.110/24 | 172.22.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| RADARSTATION-EDGE1 | Vlan4094 | 10.255.255.80 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_radarstation-edge1-1_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_radarstation-edge1-1_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet6 | SERVER_radar_eth2 | *access | *250 | *- | *- | 6 |
...
!
interface Ethernet1
   description P2P_router_eth4
   no shutdown
   mtu 1500
   no switchport
   ip address 10.250.230.13/30
!
interface Ethernet3
   description MLAG_radarstation-edge1-1_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_radarstation-edge1-1_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet6
   description SERVER_radar_eth2
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_radarstation-edge1-1_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_radarstation-edge1-1_Port-Channel3
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.255.3.10/32 |
...
!
interface Vxlan1
   description radarstation-edge1-2_VTEP
...
router bgp 65110
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description radarstation-edge1-1
   ...
   neighbor 10.255.255.112 description radarstation-edge1-1_Vlan4093
   ...
   vrf VRF-CAM
      ...
      update wait-install
      neighbor 10.255.255.112 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.255.112 description radarstation-edge1-1_Vlan3011
   ...
   vrf VRF-RDR
      ...
      update wait-install
      neighbor 10.255.255.112 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.255.112 description radarstation-edge1-1_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
