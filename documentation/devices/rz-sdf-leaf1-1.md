...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.22.0.103/24 | 172.22.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| RZ-SDF-LEAF1 | Vlan4094 | 10.255.255.69 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_rz-sdf-leaf1-2_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_rz-sdf-leaf1-2_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet5 | SERVER_sdf-server1_eth1 | *trunk | *12,250,3401-3402 | *12 | *- | 5 |
| Ethernet6 | SERVER_sdf-server2_eth1 | *trunk | *12,250,3401-3402 | *12 | *- | 6 |
| Ethernet7 | SERVER_rec-server_eth1 | *trunk | *12,219 | *12 | *- | 7 |
...
!
interface Ethernet1
   description P2P_rz-spine1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.201.9/31
!
interface Ethernet2
   description P2P_rz-spine2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.201.11/31
!
interface Ethernet3
   description MLAG_rz-sdf-leaf1-2_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_rz-sdf-leaf1-2_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description SERVER_sdf-server1_eth1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description SERVER_sdf-server2_eth1
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description SERVER_rec-server_eth1
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description P2P_router_eth1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.250.230.1/30
   ipv6 enable
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_rz-sdf-leaf1-2_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_rz-sdf-leaf1-2_Port-Channel3
   no shutdown
...
| Vlan3009 |  VRFEXT  |  10.255.255.100/31  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description rz-sdf-leaf1-1_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.250.230.2 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.255.101 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF-CAM | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.255.101 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF-RDR | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.255.101 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRFEXT | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 220 | 10.255.1.3:10220 | 10220:10220<br>remote 10220:10220 | - | - | learned |
| 250 | 10.255.1.3:10250 | 10250:10250<br>remote 10250:10250 | - | - | learned |
| 3401 | 10.255.1.3:13401 | 13401:13401<br>remote 13401:13401 | - | - | learned |
| 3402 | 10.255.1.3:13402 | 13402:13402<br>remote 13402:13402 | - | - | learned |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description rz-sdf-leaf1-2
   ...
   neighbor 10.255.3.9 description radarstation-edge1-1_Loopback0
   neighbor 10.255.201.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.201.8 remote-as 65101
   neighbor 10.255.201.8 description rz-spine1_Ethernet1
   neighbor 10.255.201.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.201.10 remote-as 65102
   neighbor 10.255.201.10 description rz-spine2_Ethernet1
   neighbor 10.255.255.101 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.255.101 description rz-sdf-leaf1-2_Vlan4093
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 11
      rd 10.255.1.3:10011
      rd evpn domain remote 10.255.1.3:10011
   ...
   vlan 12
      rd 10.255.1.3:10012
      rd evpn domain remote 10.255.1.3:10012
   ...
   vlan 219
      rd 10.255.1.3:10219
      rd evpn domain remote 10.255.1.3:10219
   ...
   vlan 220
      rd 10.255.1.3:10220
      rd evpn domain remote 10.255.1.3:10220
   ...
   vlan 250
      rd 10.255.1.3:10250
      rd evpn domain remote 10.255.1.3:10250
   ...
   vlan 3401
      rd 10.255.1.3:13401
      rd evpn domain remote 10.255.1.3:13401
   ...
   vlan 3402
      rd 10.255.1.3:13402
      rd evpn domain remote 10.255.1.3:13402
   ...
   vrf VRF-CAM
      ...
      router-id 10.255.1.3
      neighbor 10.255.255.101 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.255.101 description rz-sdf-leaf1-2_Vlan3011
   ...
   vrf VRF-RDR
      ...
      router-id 10.255.1.3
      neighbor 10.255.255.101 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.255.101 description rz-sdf-leaf1-2_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRFEXT
      rd 10.255.1.3:10
      ...
      router-id 10.255.1.3
      neighbor 10.255.255.101 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.255.101 description rz-sdf-leaf1-2_Vlan3009
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
