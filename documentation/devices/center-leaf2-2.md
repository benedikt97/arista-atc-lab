...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_rz-spine1_Ethernet4 | - | 10.255.202.21/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_rz-spine2_Ethernet4 | - | 10.255.202.23/31 | default | 1500 | False | - | - |
...
!
interface Ethernet2
   description P2P_rz-spine2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Vxlan1
   description center-leaf2-2_VTEP
...
| 220 | 10.255.1.6:10220 | 10220:10220 | - | - | learned |
| 250 | 10.255.1.6:10250 | 10250:10250 | - | - | learned |
...
router bgp 65106
   ...
   neighbor 10.255.202.20 remote-as 65101
   neighbor 10.255.202.20 description rz-spine1_Ethernet4
