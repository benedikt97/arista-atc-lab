...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_rz-sdf-leaf1-1_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_rz-sdf-leaf1-1_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
...
!
interface Ethernet3
   description MLAG_rz-sdf-leaf1-1_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_rz-sdf-leaf1-1_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_rz-sdf-leaf1-1_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_rz-sdf-leaf1-1_Port-Channel3
   no shutdown
...
| Vlan3009 |  VRFEXT  |  10.255.255.101/31  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description rz-sdf-leaf1-2_VTEP
...
| 10.255.255.100 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRFEXT | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| VRFEXT | 10.255.1.4:10 | connected | - |
...
router bgp 65104
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description rz-sdf-leaf1-1
   ...
   neighbor 10.255.3.10 description radarstation-edge1-2_Loopback0
   ...
   neighbor 10.255.255.100 description rz-sdf-leaf1-1_Vlan4093
   ...
   vrf VRF-CAM
      ...
      router-id 10.255.1.4
      neighbor 10.255.255.100 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.255.100 description rz-sdf-leaf1-1_Vlan3011
   ...
   vrf VRF-RDR
      ...
      router-id 10.255.1.4
      neighbor 10.255.255.100 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.255.100 description rz-sdf-leaf1-1_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRFEXT
      rd 10.255.1.4:10
      ...
      router-id 10.255.1.4
      neighbor 10.255.255.100 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.255.100 description rz-sdf-leaf1-1_Vlan3009
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
